...
@test "Check disallowed permissions on active site: administer module_permissions" {
  ...
  assert_output_contains "GovCMS Validate :: Disallowed permissions on active site"
  assert_output_contains "[fail]: 'anonymous' has restricted permissions: \"administer module_permissions\""
  assert_equal 1 "$(mock_get_call_num "${mock_drush}")"
